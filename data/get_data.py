"""
    data/get_data.py
    -----------------
    Helper function to retrieve data, this form an abstraction to simply call
    this function to simply call the city by name
"""
...
def get_city_data(cities: Union[str, List]="all", logger=None):
    """
    """
